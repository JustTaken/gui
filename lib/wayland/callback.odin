...
keyboard_keymap_callback :: proc(
  ...
  data := ([^]u8)(
    posix.mmap(
      ...
      {.READ},
      {.PRIVATE},
      posix.FD(arguments[1].(interface.Fd)),
      0,
    ),
  )[0:size]
  ...
  ctx.keymap = xkb.keymap_from_bytes(
    data,
    ctx.allocator,
    ctx.tmp_allocator,
  ) or_return
...
keyboard_key_callback :: proc(
  ...
  xkb.register_code(
    &ctx.keymap,
    u32(arguments[2].(interface.Uint)),
    u32(arguments[3].(interface.Uint)),
  ) or_return
...
@(private)
keyboard_modifiers_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
keyboard_repeat_info_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
  ...
  ctx.key_repeat =
    i64((1 / f32(arguments[0].(interface.Int))) * 1000 * 1000) * 1000

  return nil
}

@(private)
pointer_enter_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
pointer_axis_source_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
pointer_axis_stop_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
pointer_axis_discrete_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
pointer_axis_create_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
pointer_axis_value120_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
toplevel_configure_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
toplevel_close_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arugments: []interface.Argument,
) -> error.Error {
  ctx.running = false
...
@(private)
dma_tranche_flags_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
dma_format_table_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
  ...
  buf := ([^]u8)(
    posix.mmap(nil, uint(size), {.READ}, {.PRIVATE}, fd, 0),
  )[0:size]
  ...
  tuple_size := u32(
    mem.align_formula(int(format_size + modifier_size), int(modifier_size)),
  )
  ...
  for i in 0 ..< count {
    ...
    modifier.format = intrinsics.unaligned_load(
      (^u32)(raw_data(buf[offset:][0:format_size])),
    )

    modifier.modifier = intrinsics.unaligned_load(
...
@(private)
dma_main_device_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
  ctx.dma_main_device = intrinsics.unaligned_load(
    (^u64)(raw_data(arguments[0].(interface.Array))),
  )
...
@(private)
dma_tranche_formats_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
@(private)
dma_tranche_done_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
...
global_callback :: proc(
  ...
  case "xdg_wm_base":
    ctx.ids.xdg_wm_base = get_id(
      ctx,
      interface_name,
      {new_callback("ping", ping_callback)},
      interface.XDG_INTERFACES[:],
    ) or_return

    ctx.opcodes.pong = get_request_opcode(
      ctx,
      "pong",
      ctx.ids.xdg_wm_base,
    ) or_return

    ctx.opcodes.get_xdg_surface = get_request_opcode(
      ctx,
      "get_xdg_surface",
      ctx.ids.xdg_wm_base,
    ) or_return
    ...
    write(
      ...
      {
        arguments[0],
        interface.UnBoundNewId {
          id = interface.BoundNewId(ctx.ids.xdg_wm_base),
          interface = str,
          version = version,
        },
      },
      ctx.ids.registry,
      ctx.opcodes.registry_bind,
    ) or_return

    xdg_surface_create(ctx)
  case "wl_compositor":
    ctx.ids.compositor = get_id(
      ctx,
      interface_name,
      {},
    ...
    ctx.opcodes.create_surface = get_request_opcode(
      ctx,
      "create_surface",
      ctx.ids.compositor,
    ) or_return
    ...
    write(
      ctx,
      {
        arguments[0],
        interface.UnBoundNewId {
          id = interface.BoundNewId(ctx.ids.compositor),
          interface = str,
          version = version,
        },
      },
  ...
  case "wl_seat":
    ctx.ids.seat = get_id(
      ...
      interface_name,
      {
        new_callback("capabilities", seat_capabilities_callback),
        new_callback("name", seat_name_callback),
      },
      interface.WAYLAND_INTERFACES[:],
    ) or_return

    ctx.opcodes.get_pointer = get_request_opcode(
      ctx,
      "get_pointer",
      ctx.ids.seat,
    ) or_return

    ctx.opcodes.get_keyboard = get_request_opcode(
      ctx,
      "get_keyboard",
      ctx.ids.seat,
    ) or_return
    ...
    write(
      ctx,
      {
        arguments[0],
        interface.UnBoundNewId {
          id = interface.BoundNewId(ctx.ids.seat),
          interface = str,
          version = version,
        },
      },
  ...
  case "zwp_linux_dmabuf_v1":
    ctx.ids.dma = get_id(
      ...
      interface.DMA_INTERFACES[:],
    ) or_return

    ctx.opcodes.dma_destroy = get_request_opcode(
      ctx,
      "destroy",
      ctx.ids.dma,
    ) or_return

    ctx.opcodes.dma_create_param = get_request_opcode(
      ctx,
      "create_params",
      ctx.ids.dma,
    ) or_return

    ctx.opcodes.dma_surface_feedback = get_request_opcode(
      ctx,
    ...
    write(
      ctx,
      {
        arguments[0],
        interface.UnBoundNewId {
          id = interface.BoundNewId(ctx.ids.dma),
          interface = str,
          version = version,
        },
      },
...
@(private)
seat_capabilities_callback :: proc(
  ctx: ^Wayland_Context,
  id: u32,
  arguments: []interface.Argument,
) -> error.Error {
  ...
  capabilities := transmute(Seat_Capabilities)u32(
    arguments[0].(interface.Uint),
  )

  if .Pointer in capabilities {
    ctx.ids.pointer = get_id(
      ctx,
      "wl_pointer",
      {
        ...
        new_callback(
          ...
          pointer_axis_relative_direction_callback,
        ),
      },
      interface.WAYLAND_INTERFACES[:],
    ) or_return
    ...
    write(
      ctx,
      {interface.BoundNewId(ctx.ids.pointer)},
      ctx.ids.seat,
      ctx.opcodes.get_pointer,
    ) or_return
  }

  if .Keyboard in capabilities {
    ctx.ids.keyboard = get_id(
      ctx,
      "wl_keyboard",
      {
    ...
    write(
      ctx,
      {interface.BoundNewId(ctx.ids.keyboard)},
      ctx.ids.seat,
      ctx.opcodes.get_keyboard,
    ) or_return
  }
