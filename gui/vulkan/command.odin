...
create_command_pool :: proc(ctx: ^Vulkan_Context, queue_index: u32) -> (vk.CommandPool, Error) {
...
allocate_command_buffers :: proc(ctx: ^Vulkan_Context, command_pool: vk.CommandPool, count: u32) -> (command_buffers: []vk.CommandBuffer, err: Error) {
